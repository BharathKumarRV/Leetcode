package com.example.Leetcode.LLD;
...
public class PlaySnakeAndLadder {
	  ...
	  public static void main(String[] args) {
          ...
          Dice dice = playSnakeAndLadder.new Dice(1);
          Player p1 = playSnakeAndLadder.new Player("Alberts",1);
          Player p2 = playSnakeAndLadder.new Player("Pintoss",2);
          Queue<Player> allPlayers = new LinkedList<>();
          allPlayers.offer(p1);
          allPlayers.offer(p2);
          Jumper snake1 = playSnakeAndLadder.new Jumper(10,2);
          Jumper snake2 = playSnakeAndLadder.new Jumper(99,12);
          List<Jumper> snakes = new ArrayList<>();
          snakes.add(snake1);
          snakes.add(snake2);
          Jumper ladder1 = playSnakeAndLadder.new Jumper(5,25);
          Jumper ladder2 = playSnakeAndLadder.new Jumper(40,89);
          ...
          GameBoard gb=playSnakeAndLadder.new GameBoard(dice,allPlayers,snakes,ladders,playersCurrentPosition,100);
          gb.startGame();
      }
