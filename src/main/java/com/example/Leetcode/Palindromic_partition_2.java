...
public class Palindromic_partition_2 {
	...
	public static void helper(int index, String s, List<String> step, List<List<String>> result) {
		// Base case
		...
		for (int i = index; i <= s.length(); i++) {
			...
			helper(i + 1, s, step, result); // explore
